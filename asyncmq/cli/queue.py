...
queue_cli = Sayer(
    name="queue",
    help="Manages AsyncMQ queues.",
    invoke_without_command=True,
)


@queue_cli.callback(invoke_without_command=True)
def _queue_callback(ctx: click.Context) -> None:
    """
...
@click.command("pause-repeatable")
@click.argument("queue")
...
queue_cli.add_command(pause_queue)
queue_cli.add_command(resume_queue)
